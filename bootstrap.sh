...
resolve_ui_density() {
  ...
  case "${density}" in
    ...
    large)
      ...
      set_ui_value "waybar_network_max_length" "20"
      set_ui_value "waybar_playerctl_max_length" "28"
      set_ui_value "waybar_playerctl_min_length" "10"
    ...
    huge)
      ...
      set_ui_value "waybar_font_size" "12pt"
      set_ui_value "waybar_network_max_length" "18"
      set_ui_value "waybar_playerctl_max_length" "22"
      set_ui_value "waybar_playerctl_min_length" "0"
...
apply_ui_profile() {
  ...
  replace_or_warn "${waybar_config_file}" "s/\"max-length\": 18/\"max-length\": ${UI_PROFILE[waybar_network_max_length]}/m; s/\"max-length\": (24|28|22|18|16)/\"max-length\": ${UI_PROFILE[waybar_playerctl_max_length]}/m; s/\"min-length\": (10|0)/\"min-length\": ${UI_PROFILE[waybar_playerctl_min_length]}/m"
