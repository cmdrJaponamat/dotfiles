...
DOTBOOTSTRAP_COMPONENTS=(
  ...
  "sddm-theme|sddm/codex-gruvbox|/usr/share/sddm/themes/codex-gruvbox|optional|Custom Gruvbox SDDM theme"
...
DOTBOOTSTRAP_PACKAGE_GROUPS=(
  ...
  "display-manager|core|always|sddm qt6-svg|Display manager and theme runtime"
