...
DOTBOOTSTRAP_COMPONENTS=(
  ...
  "applications|applications|.local/share/applications|optional|User desktop entry overrides"
...
DOTBOOTSTRAP_PACKAGE_GROUPS=(
  ...
  "desktop-tools|core|always|pavucontrol blueman gnome-keyring|Desktop control panels and secret service"
